...
namespace lib_presentaciones.Implementaciones
{
    public class TipoPagosNegocioP : ITipoPagosNegocioP
    {
        ...
        public TipoPagos Guardar(TipoPagos entidad)
        {
            ...
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7256/TipoPagos/Guardar";
            ...
            if (!respuesta.ContainsKey("Valor"))
                return new TipoPagos();

            return JsonConvert.DeserializeObject<TipoPagos>(
                respuesta["Valor"].ToString()!)!;
        }
        ...
        public TipoPagos Modificar(TipoPagos entidad)
        {
            ...
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7256/TipoPagos/Modificar";
            datos["Entidad"] = entidad;
        ...
        public TipoPagos Eliminar(TipoPagos entidad)
        {
            ...
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7256/TipoPagos/Eliminar";
            datos["Entidad"] = entidad;
